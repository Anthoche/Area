 ...
 * @file CreateAcc.jsx
 * @description
 * Account creation entry point for KiKoNect.
 * Allows users to:
 *  - Sign up using email
 *  - Continue registration flow
 *  - Authenticate using Google or GitHub OAuth
 *
 * This component validates user input, handles OAuth redirects,
 * and forwards email state to the registration route.
 */
...
export default function CreateAcc() {
    ...
    /**
     * Handles email-based signup flow.
     * Only validates format and forwards email to /register.
     */
     ...
     * If a user_id exists, it is attached to link accounts.
     */
    const handleGoogleLogin = () => {
        const id = Number(localStorage.getItem("user_id"));
        // URL the backend will redirect to after successful auth
