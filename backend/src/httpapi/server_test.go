...
func (s *stubStore) Create(ctx context.Context, u *auth.User, passwordHash string) error {
	return s.err
}
func (s *stubStore) GetByEmail(ctx context.Context, email string) (*auth.User, string, error) {
